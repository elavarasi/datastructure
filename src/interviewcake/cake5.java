...
public class cake5 {
	public static void main(String args[]){
		...
		int deno[] = {1,2,3,4};
		cake5 obj1 = new cake5();
		obj1.changePossibilities(4, deno, 0);
	...
	public int changePossibilities(int amount, int[] denominators, int currentIndex){
		
		if (currentIndex == denominators.length) return 1;
		
		int value = denominators[currentIndex];
...
Here's that approach in pseudocode:
  ...
  public numberOfWays(amount, denominations) {
    answer = 0;
